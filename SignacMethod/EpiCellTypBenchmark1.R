...
#
saveRDS(Cereb,file = "~/ProjectTest/10X Filtered PBMC/Cereb1PostUMAP.rds")
#
# Restart point if needed to save time
#
Cereb <- readRDS("/Users/tedrees/ProjectTest/10X Filtered PBMC/Cereb1PostUMAP.rds")
...
saveRDS(RNAObj,file = "~/ProjectTest/RNAObjGroundTruth1.rds")
write.csv(RNAObj@meta.data,file="RNAObjmeta1.csv")  
#
...
saveRDS(ATACObj,file = "~/ProjectTest/ATACObjPredictions1.rds")
write.csv(ATACObj@meta.data,file="ATACObjPred1.csv")
